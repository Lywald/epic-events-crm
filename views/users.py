...
def create_user():
    ...
    user_role = input()
    while user_role != "Gestion"  and user_role != "Commercial" and user_role  != "Support":
        user_role = input()
    print("# Password: ")
    user_pw = input()
    ...
    myUser = UserDB(None, name=user_name, email=user_email, role=user_role, password=hashedPW)
